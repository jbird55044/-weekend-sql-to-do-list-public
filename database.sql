...
CREATE TABLE tb_flag_color (
	"id" SERIAL PRIMARY KEY,
	"color" VARCHAR (25) NOT NULL,
	"description" VARCHAR (60) NOT NULL
);

DROP TABLE tb_flag_color;

INSERT INTO tb_task_main ("name","comment","create_date","modified_date","due_date", "completed_date", "category_color", "status") values ('Graduate from Prime', 'Long awaited day is here!', '08/21/2020', '11/24/2020', '2/17/2021',null, 'Red', 'Open');
INSERT INTO tb_task_main ("name","comment","create_date","modified_date","due_date", "completed_date", "category_color", "status") values ('Cut the Grass', 'The grass is getting long, time to cut', '09/1/2020', '09/05/2020', '10/1/2020',null, 'Yellow', 'Open');
...
INSERT INTO tb_task_main ("name","comment","create_date","modified_date","due_date", "completed_date", "category_color", "status") values ('Paint Garage', 'Looks great in blue', '3/1/2019', '3/1/2019', '4/1/2019', '12/3/2019', 'Blue', 'Completed');
